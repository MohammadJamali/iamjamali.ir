...
import 'package:portfolio/models/enum_contact_host.dart' show ContactHost;
import 'package:portfolio/models/enum_icon_class.dart' show IconClass;
...
extension ContactHostExtention on ContactHost {
  IconData get icon {
    switch (this) {
      ...
      case ContactHost.github:
        return FontAwesomeIcons.github;

      case ContactHost.gitlab:
        return FontAwesomeIcons.gitlab;

      case ContactHost.bitbucket:
  ...
  Function(BuildContext, AppLocalizations) intraction(String identifier) {
    switch (this) {
      ...
      case ContactHost.github:
        return (BuildContext context, AppLocalizations localizations) {
          'https://github.com/$identifier'.tryLaunch(identifier, context);
        };
      case ContactHost.gitlab:
        return (BuildContext context, AppLocalizations localizations) {
          'https://gitlab.com/$identifier'.tryLaunch(identifier, context);
        };
      case ContactHost.bitbucket:
        return (BuildContext context, AppLocalizations localizations) {
          'https://bitbucket.org/$identifier'.tryLaunch(identifier, context);
        };
      default:
        return (BuildContext context, AppLocalizations localizations) =>
  ...
  String localize(AppLocalizations localizations) {
    switch (this) {
      ...
      case ContactHost.gitlab:
        return localizations.gitlab;
      case ContactHost.bitbucket:
        return localizations.bitbucket;
    }
  }
}
